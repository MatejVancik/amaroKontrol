        ...
        animate(view)
                ...
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        // call onOpened/onClosed 
                        if(!swap && opened.get(position)) {
                        	swipeListView.onOpened(position, swapRight);
                        } else if(!swap && !opened.get(position)) {
    ...
    void closeOpenedItems() {
        if (opened != null) {
            ...
            for (int i = start; i <= end; i++) {
            	...
            	} catch (IndexOutOfBoundsException ex) { Log.e("SwipeListView", "Index "+i+" is out of bounds while closing item.");}
            }
        }
